...
from app.facade.helper import trans_num


###同业拆借利率
def ib_rate(market='sh', fc=None):
    '''stores:同业拆借市场简称，各个市场英文缩写为：
    ...
    if market == 'ch':
        ...
        fc = 'EUR'
        period = ['1周', '2周', '3周', '1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月',
                  '1年']
    elif market == 'l':
        period = ['隔夜', '1周', '1月', '2月', '3月', '8月']
    elif market == 'hk':
        period = ['隔夜', '1周', '2周', '1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月',
                  '11月''1年']
    elif market == 's':
