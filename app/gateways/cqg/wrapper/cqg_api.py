...
from app.constants import Direction, OrderType, OrderStatus
from app.domain.position import PositionData
from app.domain.balance import AccountBalance
from app.domain.data import Quote, OrderBook, Bar
from app.utils.utility import safe_call
from app.gateways import BaseGateway
from app.gateways.cqg.wrapper.CELEnvironment import CELSinkBase
from app.gateways.cqg.wrapper.CELEnvironment import Trace
from app.gateways.cqg.wrapper.CELEnvironment import AssertMessage
...
def convert_orderstatus_cqg2qt(
    ...
    if status in (win32com.client.constants.osActiveAt,
        ...
        raise ValueError(
            f"Order status {status} is not valid to be handled by trader.")
