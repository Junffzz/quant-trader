...
def trade_indicators(df):
    ...
    # 将买卖当天的信息合并成一个dataframe (减少处理的数据量)
...
if __name__ == '__main__':
    result = start_backtest('601689', start='20200101', strategy=MR_Strategy)
    print("result = \n", result)

    # result = start_backtest('PDD', start='20200101', strategy=MR_Strategy)
    # print("result = \n", result)
