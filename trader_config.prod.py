...
FUTU_GATEWAY = {
    ...
    "port": 11111,
    "pwd_unlock": 199212,
    "rsa_file": "/workspace/private_data/futu_openD.rsa.private",
}
...
DATA_PATH = {
    "kline": "/workspace/python/quant-trader/data/k_line",
}
...
DB = {
    "sqlite3": "/workspace/python/quant-trader/data",
    "mariadb": "/workspace/python/quant-trader/data"
}
...
ACTIVATED_PLUGINS = ["mariadb", "dingtalk"]
LOCAL_PACKAGE_PATHS = []
